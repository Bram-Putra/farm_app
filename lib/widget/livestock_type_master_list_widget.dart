  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: ltmlController.getListSize(),
        itemBuilder: (context, index) {
          return Slidable(
            ...
            child: Container(
              ...
              child: ListTile(
                title: Text('Livestock: '+ltmlController.getLivestockType(index).livestockName),
                subtitle: Text(ltmlController.getLivestockTypeNotes(index)),
                onTap: () {
                  _callLivestockTypeDetail(ltmlController.getLivestockType(index));
                },
              ),
            ),
