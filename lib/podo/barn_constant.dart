...
const url_path = 'http://192.168.1.7:9999/barn/';
...
const color_primary_light = 0xFFCFD8DC;
const color_text_primary = 0xFF212121;
const color_text_secondary = 0xFF757575;
const color_text_icon = 0xFFFFFFFF;
const color_divider = 0xFFBDBDBD;
const color_accent = 0xFF9E9E9E;
const color_delete = 0xFFFF5252;
const color_dropdown_text = 0xFF00796B;
...
const IconData icon_livestock = Icons.change_history;
